package com.comp.kidsdrawingapp
...
class MainActivity : AppCompatActivity() {
            ...
            if(mBitmap != null){
                try{
                    ...
                    val f = File(externalCacheDir?.absoluteFile.toString()
                            + File.separator + "KidsDrawingApp_" + System.currentTimeMillis()/1000 + ".jpeg")
    ...
    private fun showBrushSizeChooserDialog() {
        ...
        val verysmallBtn: ImageButton = brushDialog.findViewById(R.id.ib_verysmall_brush)
